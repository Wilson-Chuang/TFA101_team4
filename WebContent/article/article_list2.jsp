...
<!-- 分類 -->
    <div class="article_category">
    	...
    	<a href="${pageContext.request.contextPath}/article/article_list2.jsp"><div class="article_category_tag" style="color:black; border-left:5px solid #ef6e51; transform: scale(1.2); margin-right:30px; margin-left:15px;">推薦美食</div></a>
