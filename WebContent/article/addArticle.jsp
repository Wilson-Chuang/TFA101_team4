...
<FORM METHOD="POST" ACTION="article.do" name="form1" enctype="multipart/form-data" target="nm_iframe" onsubmit="return dosubmit()">
...
<!-- 文章撰寫 -->
	 <div class="article_ckeditor">
 		<textarea class="ckeditor" id="myContent" name="article_content"></textarea>
 	 </div>
...
<!-- 		<input list="shop_no" name="shop_no"/>		 -->
<!-- 		<datalist id="shop_no"> -->
