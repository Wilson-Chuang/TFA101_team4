...
<%
	Article_categoryService article_categorySvc2 = new Article_categoryService();
	Set<ArticleVO> set = article_categorySvc2.getArticlesByariticle_category_no(3);
...
<!-- 分類 -->
    <div class="article_category">
    	...
    	<a href="${pageContext.request.contextPath}/article/article_list1.jsp"><div class="article_category_tag">美食開箱</div></a>
    	<a href="${pageContext.request.contextPath}/article/article_list2.jsp"><div class="article_category_tag">推薦美食</div></a>
    	<a href="${pageContext.request.contextPath}/article/article_list3.jsp"><div class="article_category_tag" style="color:black; border-left:5px solid #ef6e51; transform: scale(1.2); margin-right:30px; margin-left:15px;" >餐廳介紹</div></a>
