...
<table>
	<tr class="table_0">
		...
		<th class="table_1">揪團介紹</th>
		<th class="table_1">成團人數最多限制</th>
		<th class="table_1">成團人數最少限制</th>
		<th class="table_1">備註</th>
	</tr>
	<tr class="table_0">
		<td class="table_1"><%=partyVO.getParty_id()%></td>
		<td class="table_1"><%=partyVO.getMember_id()%></td>
		<td class="table_1"><%=partyVO.getShop_id()%></td>
		<td class="table_1"><%=partyVO.getParty_title()%></td>
		<td class="table_1"><%=partyVO.getParty_start_time()%></td>
		<td class="table_1"><%=partyVO.getParty_end_time()%></td>
		<td class="table_1"><%=partyVO.getParty_intro()%></td>
		<td class="table_1"><%=partyVO.getParty_participants_max()%></td>
		<td class="table_1"><%=partyVO.getParty_participants_min()%></td>
		<td class="table_1"><%=partyVO.getParty_remarks()%></td>
	</tr>
</table>
