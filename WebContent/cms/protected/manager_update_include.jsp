...
<link rel="stylesheet" href="${pageContext.request.contextPath}/manager/css/managerIndex.css">
</head>
...
<header class="header">
        ...
        <div class="logo"><img src="${pageContext.request.contextPath}/manager/images/logo(white).png"></div>
        ...
        <div class="user">
            ...
            <span>
                <p>&emsp; &emsp; ${managerVO.manager_account}，您好</p>
            </span>
         </div>
    </header>
...
<!--             
        ...
        <div class="main">
            <jsp:include page="/manager/update_manager_input.jsp" flush="true" />
        </div>
