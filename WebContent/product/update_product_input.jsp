				...
				<div class="product_info_form">
					...
					<div class="product_pic_upload">
						...
						<a href="javascript:void(0)"> 
							<img src="${pageContext.request.contextPath}/product/img/新增圖片.png" id="my-img"> <input type="file" name="product_img" id="img-upload">
						</a>
					</div>
					...
					<div class="form2">
						<textarea name="product_intro" rows="15" cols="80" class="ckeditor"><%=productVO.getProduct_intro()%></textarea>
					</div>
