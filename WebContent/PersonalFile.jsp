...
<div class="container">
        <div class="row">
            <div class="col-2">
                <img src="/upload/${MemberVO.member_pic}" width="150px" alt="" class="member_pic" id="showimg">
            </div>
            <div class="col-10">
                <span class="member_name">${MemberVO.member_name}</span>
                <span class="member_status">一般會員</span><br>
                <span class="comments_count">0則評論</span>
                <span class="followers_count">${MemberVO.member_fans}個粉絲</span>
                <span class="followers_count">會員ID:${MemberVO.member_id}</span>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-10">
                ...
                <tr><th>信箱:</th><td>${MemberVO.member_email}</td></tr>
                <tr><th>性別:</th><td><%if(MemberVO.getMember_gender()==1)%>男<%else%>女</td></tr>
                <tr><th>生日:</th><td>${MemberVO.member_birth}</td></tr>
                <tr><th>年齡:</th><td>${MemberVO.member_age}</td></tr>
                <tr><th>地址:</th><td>${MemberVO.member_address}</td></tr>
                <tr><th>電話:</th><td>${MemberVO.member_phone}</td></tr>
                <tr><th>註冊日期:</th><td><fmt:formatDate value="${MemberVO.member_create_time}" pattern="yyyy/MM/dd"/></td></tr>
...
<%--                     <label for="">更新日期:<fmt:formatDate value="${MemberVO.member_update_time}" pattern="yyyy/MM/dd HH:mm"/></label><br> --%>
                    ...
                    <input type=hidden name= "MEMBER_BIRTH" value="${MemberVO.member_birth}">
                    <input type=hidden name= "MEMBER_AGE" value="${MemberVO.member_age}">
                    <input type=hidden name= "MEMBER_ADDRESS" value="${MemberVO.member_address}">
                    <input type=hidden name= "MEMBER_PHONE" value="${MemberVO.member_phone}">
                    <input type=hidden name= "MEMBER_PIC" value="${MemberVO.member_pic}">
