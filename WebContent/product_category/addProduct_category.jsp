...
<title>系列管理(後台)</title>
<link rel="stylesheet" href="${pageContext.request.contextPath}/product_category/css/addProdCatg.css">
...
<body>
	...
	<script src="${pageContext.request.contextPath}/product_category/js/addProdCatg.js"></script>
</body>
